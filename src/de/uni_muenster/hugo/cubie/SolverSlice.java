...
final class SolverSlice extends Solver
{
	...
	public boolean setPosition( CubePosition cubePos, boolean test ){
		...
		if( positionlist==null ){
			...
			solamount[0]=3;
				...
				(positionlist[0][4]!=perm[4] && settings.superGroup )){
	...
	private boolean search()
	{
		...
		if( maxdepth==0 && sollen==0 && positionlist[0][0]==0 && positionlist[0][1]==0 && positionlist[0][2]==1 && positionlist[0][3]==4 && ( !settings.superGroup || positionlist[0][4]==0 ) ) return(true);
		...
		while( sollen>=0 ){
			...
			if( ( settings.superGroup || sollen+prune[positionlist[nxt][0]][positionlist[nxt][1]][positionlist[nxt][2]][positionlist[nxt][3]]<maxdepth+1 ) &&
				(!settings.superGroup || sollen+prune2[positionlist[nxt][0]][positionlist[nxt][1]][positionlist[nxt][2]][positionlist[nxt][3]][positionlist[nxt][4]]<maxdepth+1 )
			){
